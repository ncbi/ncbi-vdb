...
public:
    ...
    {
        KDirectory *subdir;
        THROW_ON_RC( KDirectoryOpenDirUpdate( m_dir, &subdir, false, "%s", path.c_str() ) );
        THROW_ON_RC( KDBManagerOpenMetadataUpdateInt ( m_mgr, (KWMetadata **)& m_meta, subdir, nullptr) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadB8_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int8_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadB16_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int16_t b;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadB32_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int32_t b;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadB64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int64_t b;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadB128_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int128_t b;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI16_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int16_t i;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI16_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    int16_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI16_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    int16_t b;
    REQUIRE_RC( KMDataNodeReadAsI16 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU16_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint16_t u;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU16_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    uint16_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU16_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    uint16_t b;
    REQUIRE_RC( KMDataNodeReadAsU16 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI32_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int32_t i;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI32_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    int32_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI32_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    int32_t b;
    REQUIRE_RC( KMDataNodeReadAsI32 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI32_From32, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b32" );
    int32_t b;
    REQUIRE_RC( KMDataNodeReadAsI32 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU32_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint32_t u;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU32_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    uint32_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU32_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    uint32_t b;
    REQUIRE_RC( KMDataNodeReadAsU32 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU32_From32, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b32" );
    uint32_t b;
    REQUIRE_RC( KMDataNodeReadAsU32 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int64_t i;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI64_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    int64_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI64_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    int64_t b;
    REQUIRE_RC( KMDataNodeReadAsI64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI64_From32, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b32" );
    int64_t b;
    REQUIRE_RC( KMDataNodeReadAsI64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsI64_From64, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b64" );
    int64_t b;
    REQUIRE_RC( KMDataNodeReadAsI64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint64_t u;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU64_From8, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col/COL1/row_count" );
    uint64_t b;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU64_From16, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b16" );
    uint64_t b;
    REQUIRE_RC( KMDataNodeReadAsU64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU64_From32, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b32" );
    uint64_t b;
    REQUIRE_RC( KMDataNodeReadAsU64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsU64_From64, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b64" );
    uint64_t b;
    REQUIRE_RC( KMDataNodeReadAsU64 ( m_node,  &b ) );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsF64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    double f;
    rc_t rc = SILENT_RC( rcDB,rcMetadata,rcReading,rcTransfer,rcIncomplete );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsF64_From32, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b32" );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAsF64_From64, KWMDataNode_Fixture)
{
    Open( ScratchDir + "TestDB", "b64" );
...
FIXTURE_TEST_CASE(KWMDataNode_ReadCString_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    char buffer[1024];
    size_t size = 1;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttr_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    char buffer[1024];
    size_t size;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsI16_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int16_t i;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsU16_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint16_t u;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsI32_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int32_t i;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsU32_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint32_t u;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsI64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    int64_t i;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsU64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    uint64_t u;
...
FIXTURE_TEST_CASE(KWMDataNode_ReadAttrAsF64_Fail, KWMDataNode_Fixture)
{
    Open( "testdb/tbl/SEQUENCE", "col" );
    double f;
