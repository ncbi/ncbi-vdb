...
{
    Setup(R"({"name":"col","type":"ascii","data":{}})");
    REQUIRE_RC_FAIL( m_col -> inflate( m_error, sizeof m_error ) );
    // cout << m_error << endl;
}
...
{
    Setup(R"({"name":"col","type":"ascii","data":[1]})");
    REQUIRE_RC_FAIL( m_col -> inflate( m_error, sizeof m_error ) );
    // cout << m_error << endl;
}
