 ...
 */
typedef struct KBTree_v1 KBTree_v1;
 ...
 */
KDB_EXTERN rc_t CC KBTreeMakeRead_v1 ( const KBTree_v1 ** bt,
    struct KFile_v1 const * backing, size_t climit );

KDB_EXTERN rc_t CC KBTreeMakeUpdate_v1 ( KBTree_v1 ** bt,
    struct KFile_v1 * backing, size_t climit );

/* AddRef
 * Release
 *  ignores NULL references
 */
KDB_EXTERN rc_t CC KBTreeAddRef_v1 ( const KBTree_v1 * self );
KDB_EXTERN rc_t CC KBTreeRelease_v1 ( const KBTree_v1 * self );
 ...
 */
KDB_EXTERN rc_t CC KBTreeDropBacking_v1 ( KBTree_v1 * self );
 ...
 */
KDB_EXTERN rc_t CC KBTreeSize_v1 ( const KBTree_v1 * self,
 ...
 *   opaque key
 */
KDB_EXTERN rc_t CC KBTreeFind_v1 ( const KBTree_v1 * self, uint64_t * id,
 ...
 *   opaque key
 */
KDB_EXTERN rc_t CC KBTreeEntry_v1 ( KBTree_v1 * self, uint64_t * id,
 ...
 */
KDB_EXTERN rc_t CC KBTreeForEach_v1 ( const KBTree_v1 * self, bool reverse,
