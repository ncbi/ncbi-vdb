 ...
 *                      Called between vdb_mbedtls_cipher_cmac_starts() or
 *                      vdb_mbedtls_cipher_cmac_reset() and
 *                      vdb_mbedtls_cipher_cmac_finish().
...
/**
 * \brief               Output CMAC.
 *                      Called after vdb_mbedtls_cipher_cmac_update().
 *                      Usually followed by vdb_mbedtls_cipher_cmac_reset(), then
 *                      vdb_mbedtls_cipher_cmac_starts(), or vdb_mbedtls_cipher_free().
 *
 * \param ctx           CMAC context
 ...
 *                      Called after vdb_mbedtls_cipher_cmac_finish() and before
 *                      vdb_mbedtls_cipher_cmac_update().
 *
