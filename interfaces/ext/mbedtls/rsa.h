 ...
 *                 See \c vdb_mbedtls_rsa_init() for details.
 *
 ...
 *
 * \note           vdb_mbedtls_rsa_init() must be called beforehand to setup
 *                 the RSA context.
 *
 ...
 * \note           \c vdb_mbedtls_rsa_rsassa_pss_sign() for details on md_alg and hash_id.
 */
 ...
 *
 * \note           In case of PKCS#1 v2.1 encoding, see comments on
 *                 \c vdb_mbedtls_rsa_rsassa_pss_verify() about md_alg and hash_id.
 */
