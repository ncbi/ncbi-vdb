 ...
 *   call to the function vdb_mbedtls_param_failed()
 * - immediately return (with a specific error code unless the function
 *   returns void and can't communicate an error).
 *
 * When defining this flag, you also need to:
 * - either provide a definition of the function vdb_mbedtls_param_failed() in
 ...
 *              provided that invokes the function vdb_mbedtls_param_failed(),
