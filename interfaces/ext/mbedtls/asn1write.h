 ...
 */
int vdb_mbedtls_asn1_write_len( unsigned char **p, unsigned char *start,
                            size_t len );
/**
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int vdb_mbedtls_asn1_write_tag( unsigned char **p, unsigned char *start,
                            unsigned char tag );
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int vdb_mbedtls_asn1_write_mpi( unsigned char **p, unsigned char *start,
                            const mbedtls_mpi *X );
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int vdb_mbedtls_asn1_write_algorithm_identifier( unsigned char **p,
                                             unsigned char *start,
                                             const char *oid, size_t oid_len,
                                             size_t par_len );
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int vdb_mbedtls_asn1_write_bool( unsigned char **p, unsigned char *start,
                             int boolean );
 ...
 * \return          A negative \c MBEDTLS_ERR_ASN1_XXX error code on failure.
 */
int vdb_mbedtls_asn1_write_enum( unsigned char **p, unsigned char *start, int val );
 ...
 */
int vdb_mbedtls_asn1_write_tagged_string( unsigned char **p, unsigned char *start,
 ...
 * \return          A negative error code on failure.
 */
int vdb_mbedtls_asn1_write_printable_string( unsigned char **p,
                                         unsigned char *start,
 ...
 * \return          A negative error code on failure.
 */
int vdb_mbedtls_asn1_write_utf8_string( unsigned char **p, unsigned char *start,
                                    const char *text, size_t text_len );
 ...
 * \return          A negative error code on failure.
 */
int vdb_mbedtls_asn1_write_named_bitstring( unsigned char **p,
                                        unsigned char *start,
 ...
 */
mbedtls_asn1_named_data *vdb_mbedtls_asn1_store_named_data( mbedtls_asn1_named_data **list,
                                        const char *oid, size_t oid_len,
