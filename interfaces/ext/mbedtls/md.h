 ...
 *                  Prepares the context for vdb_mbedtls_md_setup() or vdb_mbedtls_md_free().
 */
void vdb_mbedtls_md_init( mbedtls_md_context_t *ctx );

/**
 * \brief           Free and clear the internal structures of ctx.
 *                  Can be called at any time after vdb_mbedtls_md_init().
 *                  Mandatory once vdb_mbedtls_md_setup() has been called.
 */
 ...
 *                  Should be called after vdb_mbedtls_md_init() or vdb_mbedtls_md_free().
 ...
 *                  Generally called after vdb_mbedtls_md_setup() or vdb_mbedtls_md_finish().
 *                  Followed by vdb_mbedtls_md_update().
 *
 ...
 *                  Called between vdb_mbedtls_md_starts() and vdb_mbedtls_md_finish().
 ...
 *                  Called after vdb_mbedtls_md_update().
 *                  Usually followed by vdb_mbedtls_md_free() or vdb_mbedtls_md_starts().
 *
 * \param ctx       Generic message digest context
 ...
 *                  Usually called after vdb_mbedtls_md_setup() or vdb_mbedtls_md_hmac_finish().
 *
 ...
 *                  Called between vdb_mbedtls_md_hmac_starts() or vdb_mbedtls_md_hmac_reset()
 *                  and vdb_mbedtls_md_hmac_finish().
 *                  May be called repeatedly.
 *
 * \param ctx       HMAC context
 * \param input     buffer holding the  data
...
/**
 * \brief           Output HMAC.
 *                  Called after vdb_mbedtls_md_hmac_update().
 *                  Usually followed by vdb_mbedtls_md_hmac_reset(),
 *                  vdb_mbedtls_md_hmac_starts(), or vdb_mbedtls_md_free().
 *
 * \param ctx       HMAC context
 ...
 *                  Called after vdb_mbedtls_md_hmac_finish() and before
