...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_UNRECOGNIZED = 3,               /* "unrecognized token"  */
  YYSYMBOL_jsonSTRING = 4,                 /* "string"  */
  YYSYMBOL_jsonNUMBER = 5,                 /* "number"  */
  YYSYMBOL_jsonTRUE = 6,                   /* "true"  */
  YYSYMBOL_jsonFALSE = 7,                  /* "false"  */
  YYSYMBOL_jsonNULL = 8,                   /* "null"  */
  YYSYMBOL_9_ = 9,                         /* '{'  */
  YYSYMBOL_10_ = 10,                       /* '}'  */
  YYSYMBOL_11_ = 11,                       /* ':'  */
  YYSYMBOL_12_ = 12,                       /* ','  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined JSON_LTYPE_IS_TRIVIAL && JSON_LTYPE_IS_TRIVIAL \
...
{
       0,   111,   111,   115,   121,   126,   133,   142,   143,   144,
     145,   146,   147,   148,   152,   158,   162,   169
};
#endif
...
{
  "\"end of source\"", "error", "\"invalid token\"",
  "\"unrecognized token\"", "\"string\"", "\"number\"", "\"true\"",
  "\"false\"", "\"null\"", "'{'", "'}'", "':'", "','", "'['", "']'",
  "$accept", "parse", "object", "members", "value", "array", "elements", YY_NULLPTR
};
...
#  elif defined JSON_LTYPE_IS_TRIVIAL && JSON_LTYPE_IS_TRIVIAL
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, struct KJsonValue ** root, struct JsonScanBlock* sb)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (yylocationp);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, YYLTYPE const * const yylocationp, struct KJsonValue ** root, struct JsonScanBlock* sb)
{
  ...
  YYFPRINTF (yyo, ": ");
  yy_symbol_value_print (yyo, yykind, yyvaluep, yylocationp, root, sb);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, YYLTYPE *yylsp,
                 int yyrule, struct KJsonValue ** root, struct JsonScanBlock* sb)
{
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, YYLTYPE *yylocationp, struct KJsonValue ** root, struct JsonScanBlock* sb)
{
  YY_USE (yyvaluep);
  YY_USE (yylocationp);
  YY_USE (root);
  ...
  switch (yykind)
    ...
    case YYSYMBOL_UNRECOGNIZED: /* "unrecognized token"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;

    case YYSYMBOL_jsonSTRING: /* "string"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;

    case YYSYMBOL_jsonNUMBER: /* "number"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;

    case YYSYMBOL_jsonTRUE: /* "true"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;

    case YYSYMBOL_jsonFALSE: /* "false"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;

    case YYSYMBOL_jsonNULL: /* "null"  */
            {
    KJsonValueWhack ( (*yyvaluep) . node );
}
        break;
...
# if defined JSON_LTYPE_IS_TRIVIAL && JSON_LTYPE_IS_TRIVIAL
  = { 1, 1, 1, 1 }
# endif
;
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* parse: value "end of source"  */
  ...
  case 6: /* members: members ',' "string" ':' value  */
        {
  ...
  case 13: /* value: "null"  */
                    { CHECK_RC ( KJsonMakeNull ( & yyval . node ) ); }
    break;
  ...
  case 17: /* elements: elements ',' value  */
        {
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, yylsp, root, sb);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, yylsp, root, sb);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
