...
LIB_EXPORT rc_t KHashTableSave ( const KHashTable *self, KDataBuffer *outbuf )
{
    rc_t rc = 0;
    ...
    // rc=KDataBufferMakeBytes(outbuf,1);
    return rc;
}
...
LIB_EXPORT bool KHashTableFind (
...
LIB_EXPORT bool KHashTableDelete (
