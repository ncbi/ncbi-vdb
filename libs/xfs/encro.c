...
/*
XFSLogDbg ( "XFSEncNodeDispose ( 0x%p ) [T=%d]\n", ( void * ) Node, ( Node == NULL ? 0 : Node -> type ) );
*/
...
/*
    XFSLogDbg ( "_EncNodeFile_dispose_v1 ( 0x%p )\n", ( void * ) self );
*/
...
{
/*
    XFSLogDbg ( "_EncAttr_dispose_v1 ( 0x%p )\n", ( void * ) self );
*/
