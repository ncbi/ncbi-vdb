...
)
{
    ...
    BF [0] = 0;
    __SomeCrapScrap__ ( BF, AccessMode, GENERIC_READ, "GENERIC_READ" );
    __SomeCrapScrap__ ( BF, AccessMode, GENERIC_WRITE, "GENERIC_WRITE" );
    __SomeCrapScrap__ ( BF, AccessMode, DELETE, "DELETE" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_READ_DATA, "FILE_READ_DATA" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_READ_ATTRIBUTES, "FILE_READ_ATTRIBUTES" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_READ_EA, "FILE_READ_EA" );
    __SomeCrapScrap__ ( BF, AccessMode, READ_CONTROL, "READ_CONTROL" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_WRITE_DATA, "FILE_WRITE_DATA" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_WRITE_ATTRIBUTES, "FILE_WRITE_ATTRIBUTES" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_WRITE_EA, "FILE_WRITE_EA" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_APPEND_DATA, "FILE_APPEND_DATA" );
    __SomeCrapScrap__ ( BF, AccessMode, WRITE_DAC, "WRITE_DAC" );
    __SomeCrapScrap__ ( BF, AccessMode, WRITE_OWNER, "WRITE_OWNER" );
    __SomeCrapScrap__ ( BF, AccessMode, SYNCHRONIZE, "SYNCHRONIZE" );
    __SomeCrapScrap__ ( BF, AccessMode, FILE_EXECUTE, "FILE_EXECUTE" );
    __SomeCrapScrap__ ( BF, AccessMode, STANDARD_RIGHTS_READ, "STANDARD_RIGHTS_READ" );
    __SomeCrapScrap__ ( BF, AccessMode, STANDARD_RIGHTS_WRITE, "STANDARD_RIGHTS_WRITE" );
    __SomeCrapScrap__ ( BF, AccessMode, STANDARD_RIGHTS_WRITE, "STANDARD_RIGHTS_WRITE" );
    OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][AccessMode=%d (%s) ]\n", FileName, TheFileInfo, AccessMode, BF ) );

    BF [0] = 0;
    __SomeCrapScrap__ ( BF, ShareMode, FILE_SHARE_READ, "FILE_SHARE_READ" );
    __SomeCrapScrap__ ( BF, ShareMode, FILE_SHARE_WRITE, "FILE_SHARE_WRITE" );
    __SomeCrapScrap__ ( BF, ShareMode, FILE_SHARE_DELETE, "FILE_SHARE_DELETE" );
    OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][ShareMode=%d (%s) ]\n", FileName, TheFileInfo, ShareMode, BF ) );
    
    * BF = 0;
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_ARCHIVE, "FILE_ATTRIBUTE_ARCHIVE" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_ENCRYPTED, "FILE_ATTRIBUTE_ENCRYPTED" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_HIDDEN, "FILE_ATTRIBUTE_HIDDEN" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_NORMAL, "FILE_ATTRIBUTE_NORMAL" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_NOT_CONTENT_INDEXED, "FILE_ATTRIBUTE_NOT_CONTENT_INDEXED" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_OFFLINE, "FILE_ATTRIBUTE_OFFLINE" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_READONLY, "FILE_ATTRIBUTE_READONLY" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_SYSTEM, "FILE_ATTRIBUTE_SYSTEM" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_ATTRIBUTE_TEMPORARY, "FILE_ATTRIBUTE_TEMPORARY" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_WRITE_THROUGH, "FILE_FLAG_WRITE_THROUGH" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_OVERLAPPED, "FILE_FLAG_OVERLAPPED" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_NO_BUFFERING, "FILE_FLAG_NO_BUFFERING" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_RANDOM_ACCESS, "FILE_FLAG_RANDOM_ACCESS" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_SEQUENTIAL_SCAN, "FILE_FLAG_SEQUENTIAL_SCAN" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_DELETE_ON_CLOSE, "FILE_FLAG_DELETE_ON_CLOSE" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_BACKUP_SEMANTICS, "FILE_FLAG_BACKUP_SEMANTICS" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_POSIX_SEMANTICS, "FILE_FLAG_POSIX_SEMANTICS" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_OPEN_REPARSE_POINT, "FILE_FLAG_OPEN_REPARSE_POINT" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, FILE_FLAG_OPEN_NO_RECALL, "FILE_FLAG_OPEN_NO_RECALL" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_ANONYMOUS, "SECURITY_ANONYMOUS" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_IDENTIFICATION, "SECURITY_IDENTIFICATION" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_IMPERSONATION, "" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_DELEGATION, "SECURITY_DELEGATION" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_CONTEXT_TRACKING, "SECURITY_CONTEXT_TRACKING" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_EFFECTIVE_ONLY, "SECURITY_EFFECTIVE_ONLY" );
    __SomeCrapScrap__ ( BF, FlagsAndAttributes, SECURITY_SQOS_PRESENT, "SECURITY_SQOS_PRESENT" );
    OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][FlagsAndAttributes=%d (%s) ]\n", FileName, TheFileInfo, FlagsAndAttributes, BF ) );

    * BF = 0;
    switch ( CreationDisposition ) {
        case CREATE_NEW : OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][CreationDisposition=%d (CREATE_NEW) ]\n", FileName, TheFileInfo, AccessMode ) ); break;
        case OPEN_ALWAYS : OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][CreationDisposition=%d (OPEN_ALWAYS) ]\n", FileName, TheFileInfo, AccessMode ) ); break;
        case CREATE_ALWAYS : OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][CreationDisposition=%d (CREATE_ALWAYS) ]\n", FileName, TheFileInfo, AccessMode ) ); break;
        case OPEN_EXISTING : OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][CreationDisposition=%d (OPEN_EXISTING) ]\n", FileName, TheFileInfo, AccessMode ) ); break;
        case TRUNCATE_EXISTING : OUTMSG ( ( "    CREATEFILE(Dokan): [%s][0x%p][CreationDisposition=%d (TRUNCATE_EXISTING) ]\n", FileName, TheFileInfo, AccessMode ) ); break;
    }
