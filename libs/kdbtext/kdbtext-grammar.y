...
%destructor {
 ...
 /* !!! Keep token declarations in synch with kdbtext-ast.y */
...
%token PT_VIEWSPEC
 ...
 /* !!! Keep token declarations above in synch with kdbtext-ast.y */
...
source
    : kdbtext_1_0                    { $$ . subtree = MakeTree ( ctx, PT_SOURCE, P ( $1 ) ); }
    | version_1_0 kdbtext_1_0_opt    { $$ . subtree = MakeTree ( ctx, PT_SOURCE, P ( $1 ), P ( $2 ) ); }
    | version_2_0 kdbtext_2_0_opt    { $$ . subtree = MakeTree ( ctx, PT_SOURCE, P ( $1 ), P ( $2 ) ); }
    ;
...
kdbtext_1_0_opt
    : kdbtext_1_0    { $$ . subtree = P ( $1 ); }
    | empty         { $$ = $1; }
    ;

kdbtext_1_0
    : kdbtext_1_0_decl              { $$ . subtree = MakeTree ( ctx, PT_SCHEMA_1_0, P ( $1 ) ); }
    | kdbtext_1_0 kdbtext_1_0_decl   { $$ . subtree = AddToList ( ctx, P ( $1 ) , P ( $2 ) ); }
    ;
...
typedef_1_0_decl
    :   KW_typedef
        fqn_1_0 /* must be from 'typedef' or kdbtext template */
...
opt_func_1_0_kdbtext_sig
    : empty                     { $$ = $1; }
    | func_1_0_kdbtext_sig       { $$ = $1; }
    ;

func_1_0_kdbtext_sig
    : '<' func_1_0_kdbtext_formals '>'       { $$ . subtree = MakeTree ( ctx, PT_SCHEMASIG, T ( ctx, $1 ), P ( $2 ), T ( ctx, $3 ) ); }
    ;

func_1_0_kdbtext_formals
    : func_1_0_kdbtext_formal                                { $$ . subtree = MakeList ( ctx, $1 ); }
    | func_1_0_kdbtext_formals ',' func_1_0_kdbtext_formal    { $$ . subtree = AddToList ( ctx, P ( $1 ), T ( ctx, $2 ), P ( $3 ) ); }
    ;

func_1_0_kdbtext_formal
...
script_1_0_decl
    : KW_kdbtext func_1_0_decl                                   /* MUST have a function body      */
                            { $$ . subtree = MakeTree ( ctx, PT_SCHEMA, T ( ctx, $1 ), P ( $2 ) ); }
    | KW_kdbtext KW_function func_1_0_decl                       /* "function" keyword is optional */
...
phys_1_0_return_type
    ...
    | KW___no_header func_1_0_return_type   { $$ . subtree = MakeTree ( ctx, PT_NOHEADER, T ( ctx, $1 ), P ( $2 ) ); }  /* not supported with kdbtext signature */
    ;
...
phys_enc_ref
    : '<' kdbtext_parms_1_0 '>' fqn_opt_vers opt_factory_parms_1_0
...
phys_coldef_1_0
    : opt_col_kdbtext_parms_1_0 fqn_opt_vers opt_factory_parms_1_0
            { $$ . subtree = MakeTree ( ctx, PT_PHYSCOLDEF, P ( $1 ), P ( $2 ), P ( $3 ) ); }
    ;

opt_col_kdbtext_parms_1_0
    : empty                             { $$ = $1; }
    | '<' col_kdbtext_parms_1_0 '>'      { $$ . subtree = MakeTree ( ctx, PT_COLSCHEMAPARMS, T ( ctx, $1 ), P ( $2 ), T ( ctx, $3 ) ); }
    ;

col_kdbtext_parms_1_0
    : col_kdbtext_parm_1_0                           { $$ . subtree = MakeList ( ctx, $1 ); }
    | col_kdbtext_parms_1_0 ',' col_kdbtext_parm_1_0  { $$ . subtree = AddToList ( ctx, P ( $1 ), T ( ctx, $2 ), P ( $3 ) ); }
    ;

col_kdbtext_parm_1_0
    : fqn_1_0 '=' col_kdbtext_value_1_0      { $$ . subtree = MakeTree ( ctx, PT_COLSCHEMAPARAM, P ( $1 ), T ( ctx, $2 ), P ( $3 ) ); }
    | col_kdbtext_value_1_0                  { $$ = $1; }
    ;

col_kdbtext_value_1_0
    : fqn_1_0                               { $$ = $1; }
    | uint_expr_1_0                         { $$ = $1; }
    ;
...
kdbtext_parms_1_0
    : kdbtext_parm_1_0                       { $$ . subtree = MakeList ( ctx, $1 ); }
    | kdbtext_parms_1_0 ',' kdbtext_parm_1_0  { $$ . subtree = AddToList ( ctx, P ( $1 ), T ( ctx, $2 ), P ( $3 ) ); }
    ;
...
type_expr_1_0
    : typespec_1_0              { $$ = $1; } /* datatype, typeset, kdbtexttype */
...
fqn_1_0
    ...
    /* a hack to handle keywords used as namespace identifiers in existing 1.0 kdbtexts */
...
kdbtext_2_0_opt
    : kdbtext_2_0    { $$ . subtree = P ( $1 ); }
    | empty         { $$ = $1; }
    ;

kdbtext_2_0
    : kdbtext_2_0_decl              { $$ . subtree = MakeTree ( ctx, PT_SCHEMA_2_0, P ( $1 ) ); }
    | kdbtext_2_0 kdbtext_2_0_decl   { $$ . subtree = AddToList ( ctx, P ( $1 ) , P ( $2 ) ); }
    ;
