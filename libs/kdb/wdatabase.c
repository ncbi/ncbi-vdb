 ...
 */
rc_t
KDatabaseMake ( KDatabase **dbp, const KDirectory *dir, const char *path, KMD5SumFmt *md5, bool read_only )
{
    KDatabase *db;
    rc_t rc = 0;
...
static rc_t CC KWDatabaseVOpenTableRead ( const KDatabase *self,
