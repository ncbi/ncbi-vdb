...
#ifndef _h_simple_VDBTableObj_
#define _h_simple_VDBTableObj_
 ...
 */
struct SRA_Object *VDBTableObjMake ( struct SRAException *x, struct VTable const *tbl );

#ifdef __cplusplus
}
#endif

#endif /* _h_simple_VDBTableObj_ */
