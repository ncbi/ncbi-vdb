 ...
 */
SIMPLE_EXTERN SRAMem SRAMemMake ( void *allocation, void *addr, size_t size );


/* Whack
 *  destroy memory
 */
SIMPLE_EXTERN void SRAMemWhack ( SRAMem *self );
