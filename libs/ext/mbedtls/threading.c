                       ...
                       int (*mutex_unlock)( mbedtls_threading_mutex_t * ) )
{
    ...
    mbedtls_mutex_init( &vdb_mbedtls_threading_ecp_mutex );
#endif
}
...
#if defined(MBEDTLS_ECP_INTERNAL_ALT)
    mbedtls_mutex_free( &vdb_mbedtls_threading_ecp_mutex );
#endif
}
...
#if defined(MBEDTLS_ECP_INTERNAL_ALT)
mbedtls_threading_mutex_t vdb_mbedtls_threading_ecp_mutex MUTEX_INIT;
#endif
