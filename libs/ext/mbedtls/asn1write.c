...
static int asn1_write_tagged_int( unsigned char **p, unsigned char *start, int val, int tag )
{
    ...
    MBEDTLS_ASN1_CHK_ADD( len, vdb_mbedtls_asn1_write_len( p, start, len ) );
    MBEDTLS_ASN1_CHK_ADD( len, vdb_mbedtls_asn1_write_tag( p, start, tag ) );
...
int vdb_mbedtls_asn1_write_tagged_string( unsigned char **p, unsigned char *start, int tag,
...
int vdb_mbedtls_asn1_write_utf8_string( unsigned char **p, unsigned char *start,
    const char *text, size_t text_len )
{
    return( vdb_mbedtls_asn1_write_tagged_string(p, start, MBEDTLS_ASN1_UTF8_STRING, text, text_len) );
}

int vdb_mbedtls_asn1_write_printable_string( unsigned char **p, unsigned char *start,
                                 const char *text, size_t text_len )
{
    return( vdb_mbedtls_asn1_write_tagged_string(p, start, MBEDTLS_ASN1_PRINTABLE_STRING, text, text_len) );
}

int vdb_mbedtls_asn1_write_ia5_string( unsigned char **p, unsigned char *start,
                           const char *text, size_t text_len )
{
    return( vdb_mbedtls_asn1_write_tagged_string(p, start, MBEDTLS_ASN1_IA5_STRING, text, text_len) );
}
                                        ...
                                        size_t bits )
{
    ...
    return( vdb_mbedtls_asn1_write_bitstring( p, start, buf, bits ) );
}
...
/* This is a copy of the ASN.1 parsing function vdb_mbedtls_asn1_find_named_data(),
...
mbedtls_asn1_named_data *vdb_mbedtls_asn1_store_named_data(
