...
#include "zz_config-grammar.h"
/* Symbol kind.  */
enum yysymbol_kind_t
{
  YYSYMBOL_YYEMPTY = -2,
  YYSYMBOL_YYEOF = 0,                      /* kfgEND_INPUT  */
  YYSYMBOL_YYerror = 1,                    /* error  */
  YYSYMBOL_YYUNDEF = 2,                    /* "invalid token"  */
  YYSYMBOL_kfgEND_LINE = 3,                /* kfgEND_LINE  */
  YYSYMBOL_kfgUNTERM_STRING = 4,           /* kfgUNTERM_STRING  */
  YYSYMBOL_kfgUNTERM_ESCAPED_STRING = 5,   /* kfgUNTERM_ESCAPED_STRING  */
  YYSYMBOL_kfgUNRECOGNIZED = 6,            /* kfgUNRECOGNIZED  */
  YYSYMBOL_kfgVAR_REF = 7,                 /* kfgVAR_REF  */
  YYSYMBOL_kfgUNTERM_VAR_REF = 8,          /* kfgUNTERM_VAR_REF  */
  YYSYMBOL_kfgASSIGN = 9,                  /* kfgASSIGN  */
  YYSYMBOL_kfgSTRING = 10,                 /* kfgSTRING  */
  YYSYMBOL_kfgESCAPED_STRING = 11,         /* kfgESCAPED_STRING  */
  YYSYMBOL_kfgABS_PATH = 12,               /* kfgABS_PATH  */
  YYSYMBOL_kfgREL_PATH = 13,               /* kfgREL_PATH  */
  YYSYMBOL_YYACCEPT = 14,                  /* $accept  */
  YYSYMBOL_config = 15,                    /* config  */
  YYSYMBOL_name_value_pairs = 16,          /* name_value_pairs  */
  YYSYMBOL_name_value_pair = 17,           /* name_value_pair  */
  YYSYMBOL_pathname = 18,                  /* pathname  */
  YYSYMBOL_assign_op = 19,                 /* assign_op  */
  YYSYMBOL_value = 20,                     /* value  */
  YYSYMBOL_line_end = 21                   /* line_end  */
};
...
#if (! defined yyoverflow \
     && (! defined __cplusplus \
         || (defined KFG_STYPE_IS_TRIVIAL && KFG_STYPE_IS_TRIVIAL)))
...
{
       0,    85,    85,    86,    90,    91,    95,   104,   105,   109,
     110,   114,   118,   119,   120,   121,   125,   126
};
#endif
...
{
  "kfgEND_INPUT", "error", "\"invalid token\"", "kfgEND_LINE",
...
#define yyclearin       (yychar = KFG_EMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use KFG_error or KFG_UNDEF. */
#define YYERRCODE KFG_UNDEF
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, KFGParseBlock* pb, KFGScanBlock* sb)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (pb);
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, KFGParseBlock* pb, KFGScanBlock* sb)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, pb, sb);
  YYFPRINTF (yyo, ")");
}
...
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp,
                 int yyrule, KFGParseBlock* pb, KFGScanBlock* sb)
{
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, pb, sb); \
} while (0)
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, KFGParseBlock* pb, KFGScanBlock* sb)
{
  YY_USE (yyvaluep);
  YY_USE (pb);
  YY_USE (sb);
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = KFG_EMPTY; /* Cause a token to be read.  */
  ...
  if (yychar == KFG_EMPTY)
    {
      ...
      yychar = yylex (&yylval, sb);
    }

  if (yychar <= kfgEND_INPUT)
    {
      yychar = kfgEND_INPUT;
      yytoken = YYSYMBOL_YYEOF;
      YYDPRINTF ((stderr, "Now at end of input.\n"));
    }
  else if (yychar == KFG_error)
    {
...
yyreduce:
  ...
  switch (yyn)
    {
  case 6: /* name_value_pair: pathname assign_op value line_end  */
        {
            rc_t rc=pb->write_nvp(sb->self, (yyvsp[-3].pb).tokenText, (yyvsp[-3].pb).tokenLength, (yyvsp[-1].namelist));
            if (rc != 0)
            {
                ReportRc(pb, sb, rc);
            }
            VNamelistRelease((yyvsp[-1].namelist));
        }
    break;

  case 12: /* value: kfgSTRING  */
                                { VNamelistMake(&(yyval.namelist), NAMELIST_ALLOC_BLKSIZE); AppendName(sb, (yyval.namelist), &(yyvsp[0].pb)); }
    break;

  case 13: /* value: kfgESCAPED_STRING  */
                                { VNamelistMake(&(yyval.namelist), NAMELIST_ALLOC_BLKSIZE); AppendName(sb, (yyval.namelist), &(yyvsp[0].pb)); }
    break;

  case 14: /* value: value kfgSTRING  */
                                { AppendName(sb, (yyvsp[-1].namelist), &(yyvsp[0].pb)); (yyval.namelist)=(yyvsp[-1].namelist); }
    break;

  case 15: /* value: value kfgESCAPED_STRING  */
                                { AppendName(sb, (yyvsp[-1].namelist), &(yyvsp[0].pb)); (yyval.namelist)=(yyvsp[-1].namelist); }
    break;
...
yyerrlab:
  ...
  yytoken = yychar == KFG_EMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, pb, sb);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, pb, sb);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
