...
#ifndef YY_KFG_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_KFG_CONFIG_GRAMMAR_H_INCLUDED
# define YY_KFG_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_KFG_CONFIG_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_KFG_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_KFG_CONFIG_GRAMMAR_H_INCLUDED  */
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, KFGParseBlock* pb, KFGScanBlock* sb)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (pb);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, KFGParseBlock* pb, KFGScanBlock* sb)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, pb, sb);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, KFGParseBlock* pb, KFGScanBlock* sb)
{
