...
#ifndef YY_SAM_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_ALIGN_SAMEXTRACT_GRAMMAR_H_INCLUDED
# define YY_SAM_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_ALIGN_SAMEXTRACT_GRAMMAR_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_SAM_HOME_BOSHKINS_DEVEL_NCBI_VDB_LIBS_ALIGN_SAMEXTRACT_GRAMMAR_H_INCLUDED  */
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, SAMExtractor * state)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (state);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, SAMExtractor * state)
{
  YYFPRINTF (yyo, "%s %s (",
...
static void
yy_reduce_print (yy_state_t *yyssp, YYSTYPE *yyvsp, int yyrule, SAMExtractor * state)
{
