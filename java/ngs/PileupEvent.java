...
public interface PileupEvent
{
    ...
    /**
     * getDeletionCount
     * @return the number of bases remaining in deletion event i.e. the number of Reference base positions remaining until the next non-deletion event in this alignment.
     */
